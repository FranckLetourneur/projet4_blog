        ...
        if ($data->getBlogPostStatus() == 'inTrash') {
            ...
            <div class="p-2 m-2 rounded bg-info d-flex justify-content-between " >
                ...
                <div class="text-center">
                    <a href="index.php?action=unDeletePost&id=<?= $data->getBlogPostId() ?>" class="text-dark" title="Sortir ce chapitre de la corbeille"><i class="p-2 fas fa-trash-restore fa-lg"></i></i></a>
                                
                    <a href="index.php?action=erasePost&id=<?= $data->getBlogPostId() ?>" class="text-dark" title="Pour supprimer définitivement ce chapitre"><i class="p-2 fas fa-trash-alt fa-lg"></i></a>
