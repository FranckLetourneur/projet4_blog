...
foreach($comments as $data)
    {
        ...
        <div class="d-flex flex-row mb-4 border border-secondary <?= $fond;?>">
            ...
            <div class="p-2 d-flex col-1 text-center pictoCommentsAdmin">
                ...
                <a href="index.php?action=commentsDelete&id=<?= $data['commentId'] ?>" onclick=" return confirm('Etes-vous sûr de vouloir supprimer ce commentaire ? ');" class="text-dark" title="Pour supprimer le commentaire"><i class="p-2 fas fa-trash-alt fa-lg"></i></a>
            </div>    
        </div>
